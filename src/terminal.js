...
const COMMANDS = {
  ...
  skills: () => [
    ...
    { t: "  TypeScript · JavaScript · Python · C++ · C · SQL" },
    { t: "Frontend", c: "accent" },
    { t: "  React · Next.js · Tailwind · Zustand · Three.js · Streamlit" },
    { t: "Backend", c: "accent" },
    { t: "  Node · Express · FastAPI · REST · WebSockets · JWT/OAuth" },
    { t: "Databases", c: "accent" },
    { t: "  PostgreSQL · MongoDB · Supabase · Redis · Prisma · pgvector" },
    { t: "System design", c: "accent" },
    { t: "  Caching · Load balancing · Queues · Microservices · Indexing" },
    { t: "AI / ML", c: "accent" },
    { t: "  Agentic AI · LangChain · MCP · RAG · Ollama · CV · sklearn" },
    { t: "Cloud", c: "accent" },
    { t: "  AWS (S3, EC2, IAM) · Docker · Vercel · GitHub Actions" },
  ],
  awards: () => [
  ...
  hire: () => [
    { t: "status   available now", c: "accent" },
    { t: "" },
    { t: "  freelance    full-stack builds · project or hourly · remote" },
    { t: "  internships  SWE / AI / platform · summer 2026" },
    { t: "  new-grad     full-time software & AI roles · from July 2026" },
    { t: "" },
    { t: "type 'contact' to reach me — usually replies within a day", c: "dim" },
  ],
  contact: () => [
...
const EGGS = {
  ...
  ls: [{ t: "work  about  stack  recognition  hire  contact", c: "dim" }],
